    ...
    const fetchGenres = async () => {
      const options = {
        ...
        headers: {
          ...
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJmM2YxNzk3Y2E3MzYyOTk5ZjNlMDE4YWE2ZTU1M2JkMSIsIm5iZiI6MTcxOTIyODYyOC4yNjU1MSwic3ViIjoiNjY3OTRjOTgxMGI0Zjg5NGJjOWY0NjcyIiwic2NvcGVzIjpbImFwaV9yZWFkIl0sInZlcnNpb24iOjF9.0AoNuVUUah0jqfV6c6s0p6T8zGQKLGXLDD5OQOtL1BE",
        },
      };
